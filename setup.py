...
setup(
    ...
    url='https://github.com/reachcorp/reach.git',  ### Optional

    ### This should be your name or the name of the organization which owns the
    ### project.
    author='reachcorp',  ### Optional

    ### This should be a valid email address corresponding to the author listed
    ### above.
    author_email='reachcorp@reachcorp.com',  ### Optional
...
def dl_module_from_github(module_name, repo_url):
    ...
    if not os.path.exists(module_name):
        ...
        Repo.clone_from(repo_url, module_name)
        print("succes")
    else:
    ...
    try:
        os.system("pip install -r ./"+module_name+"/requirements.txt")
    except:
        pass

    ### pip install module
    try:
        os.system("pip install -e "+module_name)
    except:
        pass
